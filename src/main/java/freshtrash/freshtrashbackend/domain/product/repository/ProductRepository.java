package freshtrash.freshtrashbackend.domain.product.repository;
...
import freshtrash.freshtrashbackend.domain.product.repository.custom.CustomProductRepository;
...
public interface ProductRepository
    ...
    Optional<ProductFileNameSummary> findFileNameById(Long productId);
    ...
    void updateSellStatus(Long productId, ProductSellStatus productSellStatus);
    ...
    @EntityGraph(attributePaths = "member")
    Page<Product> findAllByMemberIdAndSellStatusNot(
            Long memberId, ProductSellStatus productSellStatus, Pageable pageable);
}

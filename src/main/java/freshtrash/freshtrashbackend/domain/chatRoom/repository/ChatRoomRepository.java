package freshtrash.freshtrashbackend.domain.chatRoom.repository;
...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    ...
    List<ChatRoom> findByProduct_IdAndSellStatusNot(Long productId, ChatRoomSellStatus sellStatus);
    ...
    void updateSellStatus(Long chatRoomId, ChatRoomSellStatus sellStatus);
